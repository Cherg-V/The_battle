    ...
    while True:
        if unit1._get_health() > 0 and unit2._get_health() > 0 and unit3._get_health() > 0 and unit4._get_health() > 0:
            ...
            if unit1._get_health() <= 0:
                print(f"{unit1.__class__.__name__} Погиб")
            elif unit2._get_health() <= 0:
                print(f"{unit2.__class__.__name__} Погиб")
            elif unit3._get_health() <= 0:
                print(f"{unit3.__class__.__name__} Погиб")
            elif unit4._get_health() <= 0:
                print(f"{unit4.__class__.__name__} Погиб")


battle = fight(unit1, unit2, unit3, unit4)
print(battle)
